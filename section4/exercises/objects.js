...
var email = {
  ...
  to: "Daniel",
  time: 4 + " PM",
  subject: "dog games event",
  msg: "The next dog games event is this Saturday. We should go!"
}
...
var emails = [
  {
    ...
    msg: "Hi Cameron. I wanted to check in about our deadlines for the holiday project. Can we move our text due date to next Tuesday?"
  },
  {
    from: "Serena",
    to: "Michelle",
    time: 6 + " PM",
    subject: "Next Lesson",
    msg: "Hello Michelle! For our next lesson, can we go over Lightroom workflows? I'd love to make my editing process more efficient. Let me know when you're free next week.",
  },
  {
    from: "Priyanka",
    to: "Evelyn",
    time: 8 + " AM",
    subject: "Driveway",
    msg: "Good morning Evelyn. I just wanted to give you a heads up that they're paving the driveway in front of the museum today. Please use the back entrance to the building.",
  }
]
